...
export default function Login() {
    ...
    return (
        <Container sx={{ height: "70vh", width: "100vw", display: "flex", alignItems: "center", justifyContent:"center"}}>
            <Box sx={{
                p:5,
                width:"55%",
...
//   border: 1px solid rgba(255, 255, 255, 0.125);
                ...
                <Box sx={{width:"100%"}}>
                    <Typography fontFamily={"'Signika Negative', sans-serif;"} align="center" sx={{ fontSize: { xs: '30px', md: '3vw', color: "#fff" } }}>
                        Log In to EDC JGEC
                    </Typography>
                </Box>
